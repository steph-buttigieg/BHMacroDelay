...
datablocks = {"POS ":["Coordinates",3], 
            ...
            "FACA":["MaxFaceAngle",1],
            "COOR":["GFM_CoolingRate",1],
            "COHE":["CoolingHeatingEnergy",1],
            "CLHT":["DissipationRate_DuDt",1],
            "POT ":["Potential",1],
            "MACH":["Machnumber",1],
            "EDIS":["EnergyDissipation",1],
            ...
            "JETF":["JetFlag", 1],
            "JTRC":["JetTracerField", 1],
            "JTRE":["JetTracerFieldEnergy", 1],
            "JTRM":["JetTracerFieldMass", 1],
            "JTRS":["JetTracerFieldMassSouth", 1],
            "TRCE":["TracerField", 1],
            "dRho":["DensityGradient", 3],
            "VORT":["Vorticity", 3],
            "DIVV":["VelocityDivergence",1],
            "BFLD":["MagneticField",3],
            "DIVB":["MagneticFieldDivergence",1],
            "DVBA":["MagneticFieldDivergenceAlternative",1],
            "GRDV":["VelocityGradient",9],
            "BCMJ":["BH_CumMassGrowth_JET",1],
            "BCEJ":["BH_CumEgyInjection_JET",1],
            "BCMR":["BH_CumMassGrowth_RM",1],
              "BCER":["BH_CumEgyInjection_RM",1],
              "BCMQ":["BH_CumMassGrowth_QM",1],
...
def read_block(filename, block, parttype=-1, no_mass_replicate=False, verbose=False):
    ...
    if (datablocks.__contains__(block)):
